...
namespace YourVendor\Reports\Block\Adminhtml\Filter;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        /*
        * Informe date format need
        * In My case used 'mm/dd/Y'
        * Have a Fun 
        */

        $dateFormat = 'mm/dd/Y'; //$this->_localeDate->getDateFormat(\IntlDateFormatter::SHORT); 
